...
const options: ApexOptions = {
  ...
  labels: ['40-days-of-Coding', 'HTML-CSS-practice', 'budget_app', 'javascript_practice'],
  legend: {
    show: true,
    position: 'bottom',
  },
